...
.c1
 ...
 $email=$_POST["email"];
 $queryh=$_POST["query_about"];
 $details=$_POST["details"];

 $mysqli=new mysqli("localhost","shashank","shasha2777","web");
 $sql="INSERT INTO contact VALUES('$firstname','$lastname','$email','$queryh','$details')";
...
<h1 align="center" style="font-family:Boogaloo;color:#66ff66;font-size:40px;padding-top:80px;">Query Successfully Submitted</h1>
<p style="font-family:Boogaloo;color:#ff7733;font-size:30px;padding-left:70px;padding-right:70px;" align="center" >We will contact you shortly
</p>
